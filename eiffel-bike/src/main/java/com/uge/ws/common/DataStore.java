...
public class DataStore {
    ...
    private void seedData() {
        ...
        addBike(new Bike(bikeSeq.getAndIncrement(), "CityBike 50", "Entry-level city bike", 120.0));
        addBike(new Bike(bikeSeq.getAndIncrement(),"CityBike 80", "Lightweight city bike", 160.0));
        addBike(new Bike(bikeSeq.getAndIncrement(),"Kids Fun 16", "Children’s bike with 16\" wheels", 90.0));
        addBike(new Bike(bikeSeq.getAndIncrement(), "Folding Go", "Compact folding commuter bike", 250.0));
        // Seed internal users
        ...
        accounts.put("ACC-001", new Account("ACC-001", "Charlie Customer", "EUR", 10000.0));
